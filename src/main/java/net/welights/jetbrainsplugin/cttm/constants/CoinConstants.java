...
public class CoinConstants {
    ...
    //非小号api暂时不支持筛选功能
    public static final String COIN_INFO_URL = "https://fxhapi.feixiaohao.com/public/v1/ticker?convert=CNY&limit=";
    public static final String COIN_NAME = "Name";
    public static final String SYMBOL = "Code";
    public static final String COIN_LATEST_PRICE_USD = "U.S. dollar";
